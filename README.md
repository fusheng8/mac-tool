...
当前稳定版本为 `0.2.9`，仅支持 Apple Silicon（arm64）和 macOS 13 Ventura 或更高版本。隐私、故障恢复和兼容性说明分别见 [PRIVACY.md](PRIVACY.md)、[docs/recovery.md](docs/recovery.md) 与 [docs/compatibility.md](docs/compatibility.md)。
...
- Apple Silicon（arm64）；0.2.9 不提供 Intel 构建。
...
gh release create 0.2.9 .build/MacTool.dmg \
  --title 0.2.9 --generate-notes --verify-tag --draft
```
